package id.ac.polinema.miniprojectabsensiguruprivate.helper;
...
public class Session {
    ...
    private static final String KELAS_SISWA_PREF = "kelas siswa";
    ...
    public void setKelasSiswa(String kelas) {
        preferences.edit().putString(KELAS_SISWA_PREF, kelas).apply();
    }
