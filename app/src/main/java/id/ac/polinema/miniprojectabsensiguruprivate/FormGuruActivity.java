...
public class FormGuruActivity extends AppCompatActivity {
    ...
    private void requestCameraPermission() {
        Dexter.withActivity(this).withPermission(Manifest.permission.CAMERA)
                .withListener(new PermissionListener() {
                    @Override
                    //akan dipanggil setelah izin diberikan
                    public void onPermissionGranted(PermissionGrantedResponse response) {
                        openCamera();
                    }

                    @Override
                    //akan dipanggil ketika izin ditolak
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        //memeriksa apakah  izin ditolak secara permanen
    ...
    private void showDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(FormGuruActivity.this);
        builder.setTitle("Need Permission");
        builder.setMessage("Aplikasi ini membutuhkan akses camera Anda!");
